...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, CountByStatusPipe, ConfirmModalComponent],
...
export class CandidateProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (from === 'candidates') {
      ...
      this.backRoute = '/job-offers'; this.backLabel = 'Back to pipeline';
    } else if (from === 'compare') {
      this.backRoute = '/job-offers'; this.backLabel = 'Back to comparison';
    } else if (from === 'scout' || from === 'dashboard') {
      this.backRoute = '/dashboard'; this.backLabel = 'Back to dashboard';
    } else if (from === 'application') {
      this.backRoute = ''; this.backLabel = 'Back to dossier';
    } else if (from === 'employees') {
      this.backRoute = '/employees'; this.backLabel = 'Back to employees';
    } else {
  ...
  goBack(): void {
    const from = this.route.snapshot.queryParamMap.get('from');
    if (from === 'application') {
      // Go back to the application dossier they came from
      this.location.back();
    } else {
